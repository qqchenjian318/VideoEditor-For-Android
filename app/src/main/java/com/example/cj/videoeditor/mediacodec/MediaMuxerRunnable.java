...
public class MediaMuxerRunnable extends Thread {
    ...
    private static AudioSettingInfo mAudioSettingInfo;
    private static MagicFilterType mFilterType;
     ...
     */
    public synchronized void addMeidaFormat(int trackIndex, MediaFormat format) {
        synchronized (lock) {
            if (mMediaMuxer == null) {
                return;
            }
